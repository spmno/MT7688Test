...
int GPIOMmap::gpio_read(int pin)
{
	uint32_t tmp = 0;
...
int GPIOMmap::gpio_set_direction(int pin, int is_output)
{
	uint32_t tmp;
...
int GPIOMmap::gpio_write(int pin, int value)
{
	uint32_t tmp;
...
int GPIOMmap::gpio_get_direction(int pin_number)
{
	return 0;
}
